...
<?php
$id_brg=mysqli_real_escape_string($koneksi,$_GET['education_id']);
$det=mysqli_query($koneksi,"select * from education where education_id='$id_brg'")or die(mysql_error());
...
?>					
	<form action="update_penerbit.php" method="post">
		<table class="table">
			<tr>
				<td></td>
				<td><input type="hidden" name="education_id" value="<?php echo $d['education_id'] ?>"></td>
			</tr>
			<tr>
				<td>Nama</td>
